...
--Napisz polecenie, które wybiera wszystkie tytuły z tablicy title i wyświetla
...
-- i watrość naliczonej kary (fine_assessed) z tablicy loanhist dla wszystkich
-- wypożyczeń dla których naliczono karę (wartość nie NULL w kolumnie fine_assessed)
...
-- firstname (imię członka biblioteki), middleinitial (inicjał drugiego imienia) i lastname (nazwisko)
-- z tablicy member dla wszystkich członków biblioteki, którzy nazywają się Anderson
...
--Zmodyfikuj polecenie, tak by zwróciło „listę proponowanych loginów e-mail” utworzonych
-- przez połączenie imienia członka biblioteki, z inicjałem drugiego imienia i pierwszymi
...
--Napisz polecenie, które wybiera title i title_no z tablicy title. Wynikiem powinna być pojedyncza
-- kolumna o formacie jak w przykładzie poniżej: The title is: Poems, title number 7
